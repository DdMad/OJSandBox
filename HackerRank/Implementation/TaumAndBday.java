...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for(int a0 = 0; a0 < t; a0++){
            ...
            BigInteger bz = new BigInteger(Integer.toString(z));
            
            BigInteger result = new BigInteger("0");
            
            if (x + z < y) {
                result = bb.multiply(bx).add(bw.multiply(new BigInteger(Integer.toString(x + z))));
            } else if (y + z < x) {
                result = bb.multiply(new BigInteger(Integer.toString(y + z))).add(bw.multiply(by));
            } else {
                result = bb.multiply(bx).add(bw.multiply(by));
            }
